...
static const int valid_fqs[TABLE_SIZE] = {200000, 400000, 533333, 800000, 998400,
			1094400, 11520000, 1209600, 1363200, 1401600,
			1478400, 1612800};
...
static int __init cpufreq_gov_dbs_init(void)
{
	...
	if (!dbs_wq) {
		pr_debug(KERN_ERR "Failed to create preservative_dbs_wq workqueue\n");
		return -EFAULT;
	}
